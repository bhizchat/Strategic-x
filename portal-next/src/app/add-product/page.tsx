    ...
    <div className="flex min-h-screen bg-[#0a0a0a]">
      ...
      <div className="flex min-w-0 flex-1 flex-col bg-[#f5f5f6] text-[#111113]">
        ...
        <div className="min-w-0 flex-1 px-8 pb-12 pt-7 max-md:px-4.5 max-md:pb-24 max-md:pt-5.5">
          <div className="mb-3.5 flex items-center gap-2 text-[0.78rem] text-[#6b6f76]">
            <a href="/my-shop" className="hover:text-[#111113]">
              My Shop
            </a>
            <span>&rsaquo;</span>
            <a href="/products" className="hover:text-[#111113]">
              Products
            </a>
            <span>&rsaquo;</span>
            <span className="font-semibold text-[#111113]">Add New Product</span>
          </div>
