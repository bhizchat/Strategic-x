...
export const metadata: Metadata = {
  title: 'Strategic X - Privacy Policy',
};
    ...
    <div className="min-h-full bg-[#f5f5f6] text-[#111113]">
      ...
      <main className="mx-auto max-w-190 px-6 pt-14 pb-20">
        ...
        <section className="mb-7">
          <h2 className="mb-2.5 text-[1.05rem] font-extrabold text-[#0a0a0a]">1. Information We Collect</h2>
          <p className="text-[0.92rem] text-[#6b6f76]">
            When you create a Strategic X account, we collect information such as your full name, email address, and password.
            Vendors may provide additional information about their shop and products.
          </p>
        </section>

        <section className="mb-7">
          <h2 className="mb-2.5 text-[1.05rem] font-extrabold text-[#0a0a0a]">2. How We Use Your Information</h2>
          <ul className="ml-5 list-disc space-y-1.5 text-[0.92rem] text-[#6b6f76]">
            <li>To create and manage your account.</li>
            <li>To operate and improve the Strategic X platform.</li>
        ...
        <section className="mb-7">
          <h2 className="mb-2.5 text-[1.05rem] font-extrabold text-[#0a0a0a]">3. Authentication Providers</h2>
          <p className="text-[0.92rem] text-[#6b6f76]">
            If you sign in with Google, we receive basic profile information (such as your name and email address) from Google to
            create or access your Strategic X account. We do not receive your Google password.
          </p>
        </section>

        <section className="mb-7">
          <h2 className="mb-2.5 text-[1.05rem] font-extrabold text-[#0a0a0a]">4. Sharing of Information</h2>
          <p className="text-[0.92rem] text-[#6b6f76]">
            We do not sell your personal information. We may share information with service providers who help us operate Strategic X
            (such as our hosting and authentication provider), or when required by law.
          </p>
        </section>

        <section className="mb-7">
          <h2 className="mb-2.5 text-[1.05rem] font-extrabold text-[#0a0a0a]">5. Data Retention</h2>
          <p className="text-[0.92rem] text-[#6b6f76]">
        ...
        <section className="mb-7">
          <h2 className="mb-2.5 text-[1.05rem] font-extrabold text-[#0a0a0a]">6. Your Choices</h2>
          <p className="text-[0.92rem] text-[#6b6f76]">
            You may update your account information at any time, or request deletion of your account by contacting the Strategic X
            team.
          </p>
        </section>

        <section className="mb-7">
          <h2 className="mb-2.5 text-[1.05rem] font-extrabold text-[#0a0a0a]">7. Security</h2>
          <p className="text-[0.92rem] text-[#6b6f76]">
        ...
        <section className="mb-7">
          <h2 className="mb-2.5 text-[1.05rem] font-extrabold text-[#0a0a0a]">8. Changes to This Policy</h2>
          <p className="text-[0.92rem] text-[#6b6f76]">
            We may update this Privacy Policy from time to time. Continued use of Strategic X after changes take effect constitutes
        ...
        <section className="mb-7">
          ...
          <p className="text-[0.92rem] text-[#6b6f76]">
            Questions about this Privacy Policy can be directed to the Strategic X team through the contact options provided on the
            platform.
          </p>
        </section>
      </main>
